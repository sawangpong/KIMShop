...
namespace KIM.models
{
    public class CustomerDAL
    {
        ...
        public int updateCustomer(Customer customer, DataActionMode mode)
        {
            ...
            return (_result = _context.SaveChanges());
        }
        ...
        public DataTable getDeliveryList(string code) => _context.DeliveryAddrs.Where(x => x.CustCode == code).OrderBy(o => o.id).Select(x=> new { 
            x.id,
            addr = x.Address +", " + x.City + ", " + x.Province + ", "+ x.Country,
            x.ContactName
            }).ToDataTable();
